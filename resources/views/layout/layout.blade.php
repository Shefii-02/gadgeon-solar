...
<head>
    ...
    <meta property="og:title" content="Gadgeon Smart Solar Solutions - Leading Solar Innovations in Kerala & India | {{ $title ?? 'HOME' }}" />
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6  d-flex align-items-center">
                        <a href="/" title="gadgeon" class="">
                            <img loading="lazy"  src="{{ asset('assets/images/gadgeon-logo.svg')}}" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-lg-9 col-sm-2 col-2  d-none d-lg-block align-self-center">
                        ...
                        <ul class="main-menu text-end gap-2">
                            <li class="menu-item ">
                                <a href="{{asset('assets/GLS_solar_e-brochure.pdf')}}"  download="Gadgeon Smart Solar.pdf" class="btn btn-theme2 rounded-5">
                    ...
                    <div class=" col-md-6 col-6  d-block d-lg-none ">
                        <div class="row">
                            ...
                            <a href="{{url('contact-us')}}" class="btn btn-theme rounded-5 btn-sm" style="padding:6px 20px !important">Contact</a>
                            </div>
                                ...
                                <li class="dropdown mb-4">
                                    ...
                                    <ul class="dropdown-menu  my-3" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li class="m-2 "><a title="Operation and Maintenance (O&M) Services"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="{{ url('operation-and-maintenance-service') }}">Operation and Maintenance
                                                (O&M) Services</a></li>
                ...
                <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                    <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                        <div class="footer-logo-wrapper text-center text-sm-start">
                            <a href="#!">
                                <img loading="lazy"  src="{{ asset('assets/images/gadgeon-logo.svg') }}" alt="Logo" width="175" height="57">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-xl-6 order-2 order-xl-1">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="{{url('about-us')}}">About</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="{{url('contact-us')}}">Contact</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="{{url('solutions')}}">Solutions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="{{url('why-choose-gadgeon-solar')}}">Why Choose GadgEon</a>
                            </li>
                        </ul>
                    </div>
