<?php $__env->startSection('contents'); ?>
                ...
                <div class="col-lg-4 mb-5 d-none">
                    <div class="card info-box3 h-100">
                        <div>
                            ...
                            <div class="mt-2 p-2 text-center">
                                <h4 class="mb-1">Adani Solar</h4>
                                <h6 class="mb-3"></h6>
                                <p>
                                    Adani Solar is a prominent solar manufacturer known for its high-performance solar panels and commitment to sustainable energy solutions. With Adani Solar as our technology partner, we enhance our solar offerings with reliable and efficient solar panels, contributing to a cleaner and greener energy landscape. 
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card info-box3 h-100">
                        <div>
                            <div class="text-center border-bottom">
                                <img loading="lazy" loading="lazy"  decoding="async" class="text-center rounded-6 mb-4"
                                src="<?php echo e(url('assets/images/logo/enphase-logo-1.png')); ?>">
    ...
    <section
        style="background-image: url(<?php echo e(url('assets/images/pictures/inner_banner_products.jpg')); ?>);background-position: center center;background-size: cover;">
        <div class="container">
            <div class="col-lg-12">
                <div class="row">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohammedshafeequekm/Documents/smart-solar/resources/views/technology-partners.blade.php ENDPATH**/ ?>