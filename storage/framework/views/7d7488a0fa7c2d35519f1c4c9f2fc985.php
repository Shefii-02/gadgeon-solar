...
<head>
    ...
    <meta property="og:title"
        content="Gadgeon Smart Solar Solutions - Leading Solar Innovations in Kerala & India | <?php echo e($title ?? 'HOME'); ?>" />
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6  d-flex align-items-center">
                        <a href="/" title="gadgeon" class="">
                            <img loading="lazy" src="<?php echo e(asset('assets/images/gadgeon-logo.svg')); ?>" alt="logo"
                                class="logo">
                        </a>
                    </div>
                    <div class="col-lg-9 col-sm-2 col-2  d-none d-lg-block align-self-center">
                        ...
                        <ul class="main-menu text-end gap-2">
                            <li class="menu-item ">
                                <a href="<?php echo e(asset('assets/GLS_solar_e-brochure.pdf')); ?>"
                    ...
                    <div class="offcanvas offcanvas-end px-5" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-header">
                            <a href="/" title="gadgeon" class="">
                                <img loading="lazy" src="<?php echo e(asset('assets/images/gadgeon-logo.svg')); ?>"
                                    alt="logo" class="logo">
                            </a>
                                ...
                                <li class="dropdown mb-4">
                                    ...
                                    <ul class="dropdown-menu  my-3" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li class="m-2 "><a title="Operation and Maintenance (O&M) Services"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('operation-and-maintenance-service')); ?>">Operation and
                                                Maintenance
                                                (O&M) Services</a></li>
                        ...
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3"
                                    href="<?php echo e(url('about-us')); ?>">About</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3"
                                    href="<?php echo e(url('contact-us')); ?>">Contact</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3"
                                    href="<?php echo e(url('solutions')); ?>">Solutions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3"
                                    href="<?php echo e(url('why-choose-gadgeon-solar')); ?>">Why Choose GadgEon</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="footer-copyright-wrapper text-center text-dark py-2">
                            <small> Copyright © <?php echo e(date('Y')); ?> Gadgeon - Smart Solar Solutions. All rights
                    ...
                    <form action="<?php echo e(route('contact-email')); ?>" method="POST" class="py-2 px-3 row">
                        ...
                        <div class="col-lg-6 mb-2">
                            ...
                            <input id="phone" required maxlength="10" minlength="10"
                                value="<?php echo e(old('mobile')); ?>" class="form-control" type="text"
                                onkeypress="if(event.which < 48 || event.which > 57 ) if(event.which != 8) return false;"
                        ...
                        <div class="col-lg-12 mb-2">
                            ...
                            <input type="text" required class="form-control" value="<?php echo e(old('subject')); ?>"
                                name="subject" >
                        </div>
                        <div class="col-lg-12 mb-2">
                            <label class="mb-2 text-light h6">Message</label>
                            <textarea type="text" name="message" class="form-control" rows="8"><?php echo e(old('message')); ?></textarea>
                        </div>
