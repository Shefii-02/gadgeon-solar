...
<head>
    ...
    <title>Gadgeon Smart Solar Solutions - Leading Solar Innovations in Kerala & India | <?php echo e($title ?? 'HOME'); ?></title>
    <meta name="description" content="Gadgeon Smart Solar Solutions offers innovative solar energy systems across Kerala and India. Join us in creating a sustainable future with advanced solar technology." />
    <meta name="keywords" content="Gadgeon Smart Solar Solutions, Solar Power, Solar Energy, Kerala Solar Solutions, India Solar Solutions, Sustainable Energy, Renewable Energy, Eco-Friendly Power" />
    <meta property="og:title" content="Gadgeon Smart Solar Solutions - Leading Solar Innovations in Kerala & India | <?php echo e($title ?? 'HOME'); ?>" />
    <meta property="og:description" content="Discover cutting-edge solar solutions with Gadgeon. Providing efficient, sustainable energy across Kerala and India for a brighter, eco-friendly future." />
    ...
    <link href="<?php echo e(asset('assets/css/style.css?v=1.8')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/css/responsive.css?v=1.7')); ?>" rel="stylesheet">
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-6  d-flex align-items-center">
                        <a href="/" title="gadgeon" class="">
                            <img loading="lazy"  src="<?php echo e(asset('assets/images/gadgeon-logo.svg')); ?>" alt="logo" class="logo">
                        </a>
                    </div>
                    <div class="col-lg-9 col-sm-2 col-2  d-none d-lg-block align-self-center">
                        ...
                        <ul class="main-menu text-end gap-2">
                            <li class="menu-item ">
                                <a href="<?php echo e(asset('assets/GLS_solar_e-brochure.pdf')); ?>"  download="Gadgeon Smart Solar.pdf" class="btn btn-theme2 rounded-5">
                                    <i class="bi bi-download me-2"></i>
                                    E-BROCHURE</a>
                            </li> 
                            <li class="menu-item ">
                                <a href="<?php echo e(url('contact-us')); ?>" class="btn btn-theme rounded-5">Contact</a>
                            </li>
                            <li class="menu-item ">
                    ...
                    <div class=" col-md-6 col-6  d-block d-lg-none ">
                        <div class="row">
                            ...
                            <a href="<?php echo e(url('contact-us')); ?>" class="btn btn-theme rounded-5 btn-sm" style="padding:6px 20px !important">Contact</a>
                            </div>
                            <div  class="col-3  d-flex align-items-center">
                            <i class="bi bi-filter-right display-3 mb-2 end-0 " type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"></i>
                            </div>
                        </div>
                    </div>
                    <div class="offcanvas offcanvas-end px-5" tabindex="-1" id="offcanvasRight"
                        ...
                        <div class="offcanvas-body mt-2">
                            <ul class="list-unstyled text-left">
                                <li class=" mb-4 <?php echo e($title == 'Home' ? 'active' : ''); ?>">
                                    <a title="Home" href="/"
                                        class="text-decoration-none text-dark fw-semibold menu-txt">Home</a>
                                </li>
                                <li class=" mb-4 <?php echo e($title == 'Solutions' ? 'active' : ''); ?>">
                                ...
                                <li class="dropdown mb-4">
                                    ...
                                    <ul class="dropdown-menu  my-3" aria-labelledby="dropdownMenuLink">
                                        <li class="m-2 border-bottom"><a title="Residential Solar Solutions"
                                                ...
                                                href="<?php echo e(url('residential-solar-solutions')); ?>">Residential
                                                Solar Solutions</a></li>
                                        <li class="m-2 border-bottom"><a title="Commercial Solar Solutions"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('commercial-solar-solutions')); ?>">Commercial
                                                Solar Solutions</a></li>
                                        <li class="m-2 border-bottom"><a title="Solar Project Development"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('solar-project-development')); ?>">Solar Project
                                                Development</a></li>
                                        <li class="m-2 border-bottom"><a title="Solar Maintenance & Support"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('solar-maintenance-support')); ?>">Solar
                                                Maintenance & Support</a></li>
                                        <li class="m-2 border-bottom"><a title="Our Turnkey Solar PV Services"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('turnkey-solar-pv-services')); ?>">Our Turnkey
                                                Solar PV Services</a></li>
                                        <li class="m-2 "><a title="Operation and Maintenance (O&M) Services"
                                                class="text-decoration-none text-dark fw-semibold menu-txt"
                                                href="<?php echo e(url('operation-and-maintenance-service')); ?>">Operation and Maintenance
                                                (O&M) Services</a></li>

                                    </ul>
                                </li>
                                <li class=" mb-4 d-none <?php echo e($title == 'Products' ? 'active' : ''); ?>">
                                    <a title="Products" href="/products"
                                        class="text-decoration-none text-dark fw-semibold menu-txt">Products</a>
                                </li>
                                <li class=" mb-4 <?php echo e($title == 'Why Choose GadgEon Solar' ? 'active' : ''); ?>">
                                    <a title="Why Choose GadgEon Solar" href="/why-choose-gadgeon-solar"
                                        class="text-decoration-none text-dark fw-semibold menu-txt">Why Choose GadgEon</a>
                                </li>
                                

                                <li class=" mb-4 <?php echo e($title == 'Technology Partners' ? 'active' : ''); ?>">
                                    <a title="Technology Partners" href="/technology-partners"
                                        class="text-decoration-none text-dark fw-semibold menu-txt">Technology Partners</a>
                                </li>
                                <li class=" mb-4 <?php echo e($title == 'About Us' ? 'active' : ''); ?>">
                                    <a title="About Us" href="/about-us"
                                        class="text-decoration-none text-dark fw-semibold menu-txt">About Us</a>
                                </li>
                                
                                <li class=" mb-4 <?php echo e($title == 'Contact Us' ? 'active' : ''); ?>">
                            ...
                            <div class="col-lg-12 social-media-section text-left">
                                <div class="mt-4 d-flex  gap-2 pe-5">
                                    <div class="social-media-btn d-flex align-items-center justify-content-center">
                                        <a href="https://www.facebook.com/gadgeonlifestyle" class=""><i class="bi bi-facebook fs-4"></i></a>
                                    </div>
                                    <div class="social-media-btn d-flex align-items-center justify-content-center">
                                        <a href="https://www.youtube.com/@gadgeonlifestyle7231" class=""><i class="bi bi-youtube fs-4"></i></a>
                                    </div>
                                    <div class="social-media-btn d-flex align-items-center justify-content-center">
                                        <a href="https://www.instagram.com/gadgeonlifestyle/" class=""><i class="bi bi-instagram fs-4"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
                    <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
                        <div class="footer-logo-wrapper text-center text-sm-start">
                            <a href="#!">
                                <img loading="lazy"  src="<?php echo e(asset('assets/images/gadgeon-logo.svg')); ?>" alt="Logo" width="175" height="57">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-xl-6 order-2 order-xl-1">
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="<?php echo e(url('about-us')); ?>">About</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="<?php echo e(url('contact-us')); ?>">Contact</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="<?php echo e(url('solutions')); ?>">Solutions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-secondary px-2 px-md-3" href="<?php echo e(url('why-choose-gadgeon-solar')); ?>">Why Choose GadgEon</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
                        <ul class="nav justify-content-center justify-content-sm-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-dark px-3" href="https://www.youtube.com/@gadgeonlifestyle7231">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
    ...
    <div class="content">
        <div class="sidebar-contact">
            ...
            <h2>Contact Us</h2>
            <div class="scroll">
                <form method="POST" action="<?php echo e(route('quote-email')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <input type="text" required="" name="fullname" class="form-control rounded-5" placeholder="Name">
                    </div>
                    <div class="mb-3">
                        <input type="email" required="" name="email" class="form-control rounded-5" placeholder="Email">
                    </div>
                    <div class="mb-3">
                        <input id="phone" maxlength="10" minlength="10" class="form-control rounded-5" type="text" required="" value="" onkeypress="if(event.which < 48 || event.which > 57 ) if(event.which != 8) return false;" autocomplete="off" name="mobile" placeholder="Phone Number">
...
<?php /**PATH /Users/mohammedshafeequekm/Documents/smart-solar/resources/views/layout/layout.blade.php ENDPATH**/ ?>