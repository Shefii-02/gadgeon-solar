                        ...
                        <form action="<?php echo e(route('contact-email')); ?>" method="POST" class="py-2 px-3 row">
                            ...
                            <div class="col-lg-12  mb-3">
                                ...
                                <input type="text" required class="form-control" name="fullname"
                                    value="<?php echo e(old('fullname')); ?>" placeholder="Full Name">
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input id="phone" required maxlength="10" minlength="10" value="<?php echo e(old('mobile')); ?>"
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohammedshafeequekm/Documents/smart-solar/resources/views/contact-us.blade.php ENDPATH**/ ?>