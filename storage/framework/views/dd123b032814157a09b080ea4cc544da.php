<?php $__env->startSection('contents'); ?>
    ...
    <section class="pt-5 second-section">
        <img loading="lazy" src="<?php echo e(url('assets/images/pictures/about-image-2.jpg')); ?>" class="w-100">
    </section>
    <section class="py-5">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row ">
                        <div class="col-lg-4 mb-3">
                            <div class="d-flex justify-content-center flex-column align-items-center">
                                ...
                                <img loading="lazy" src="<?php echo e(asset('assets/images/icons/artifical-intelligence1.png')); ?>"
                                    class="w-50">
                        ...
                        <div class="col-lg-4  mb-3">
                            <div class="d-flex justify-content-center flex-column align-items-center mt-5">
                                ...
                                <img loading="lazy" src="<?php echo e(asset('assets/images/icons/development.png')); ?>" class="w-50">
                        ...
                        <div class="col-lg-4  mb-3">
                            <div class="d-flex justify-content-center flex-column align-items-center mt-5">
                                ...
                                <img loading="lazy" src="<?php echo e(asset('assets/images/icons/data-analytics.png')); ?>"
                                    class="w-50">
                        ...
                        <div class="col-lg-4  mb-3">
                            <div class="d-flex justify-content-center flex-column align-items-center">
                                ...
                                <img loading="lazy" src="<?php echo e(asset('assets/images/icons/deployment.png')); ?>" class="w-50">
                            ...
                            <div class=" icon-part position-relative">
                                <div class=" icon-div">
                                    <img loading="lazy" loading="lazy" decoding="async" class="text-center icon"
                                        style="width:150px" src="<?php echo e(asset('assets/images/icons/1.png')); ?>">
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="card " style="border: 4px solid gray">
                                <div class="row">
                                    <div class=" icon-part position-relative">
                                        <div class=" icon-div">
                                            <img loading="lazy" loading="lazy" decoding="async" class="text-center icon"
                                                style="width:150px" src="<?php echo e(asset('assets/images/icons/2.png')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="content-div ">
                            ...
                            <div class="card " style="border: 4px solid gray">
                                <div class="row">
                                    <div class="icon-part   position-relative">
                                        <div class=" icon-div">
                                            <img loading="lazy" loading="lazy" decoding="async" class="text-center icon"
                                                style="width:150px" src="<?php echo e(asset('assets/images/icons/3.png')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="content-div">
                            ...
                            <div class="card " style="border: 4px solid gray">
                                <div class="row">
                                    <div class="icon-part   position-relative">
                                        <div class="icon-div">
                                            <img loading="lazy" loading="lazy" decoding="async" class="text-center icon"
                                                style="width:150px" src="<?php echo e(asset('assets/images/icons/4.png')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="content-div">
                                            ...
                                            <img loading="lazy" loading="lazy" decoding="async"
                                                ...
                                                src="<?php echo e(asset('assets/images/icons/Image-6@2x.png')); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class=" icon-part  position-relative">
                                        <div class="text-left  icon-div">
                                            <img loading="lazy" loading="lazy" decoding="async" class="text-center icon"
                                                style="width:150px" src="<?php echo e(asset('assets/images/icons/5.png')); ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-6">
                                                    <img loading="lazy" loading="lazy" decoding="async"
                                                        ...
                                                        src="<?php echo e(asset('assets/images/icons/logo-01-1.svg')); ?>">
                                                </div>
                                                <div class="col-lg-6">
                                                    <img loading="lazy" loading="lazy" decoding="async"
                                                        class="text-center w-100"
                                                        src="<?php echo e(asset('assets/images/icons/logo-02-1.svg')); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohammedshafeequekm/Documents/smart-solar/resources/views/about-us.blade.php ENDPATH**/ ?>