 <section class="py-5">
        <div class="container">
            <div class="col-lg-12">
                <div class="col-lg-8 mx-auto text-center py-5">
                    ...
                    <div class="mt-5">
                        <a href="<?php echo e(url('contact-us')); ?>" class="btn btn-theme2">Call Us Now</a>
                    </div>
    ...
    </section><?php /**PATH /home/ynd9voh7vtk3/smart-solar/resources/views/call-us-now.blade.php ENDPATH**/ ?>